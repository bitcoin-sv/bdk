...
def test_Versioning():
    ...
    #assert PySESDK.SESDK_CORE_VERSION_MAJOR <= PySESDK.SESDK_PYTHON_VERSION_MAJOR;
    #assert PySESDK.SESDK_CORE_VERSION_MINOR <= PySESDK.SESDK_PYTHON_VERSION_MINOR;
    #assert PySESDK.SESDK_CORE_VERSION_PATCH <= PySESDK.SESDK_PYTHON_VERSION_PATCH;

    #assert PySESDK.SESDK_PYTHON_VERSION_MAJOR <= PySESDK.SESDK_VERSION_MAJOR;
    #assert PySESDK.SESDK_PYTHON_VERSION_MINOR <= PySESDK.SESDK_VERSION_MINOR;
    #assert PySESDK.SESDK_PYTHON_VERSION_PATCH <= PySESDK.SESDK_VERSION_PATCH;

    py_version_str = str(PySESDK.SESDK_PYTHON_VERSION_MAJOR) + "." + str(PySESDK.SESDK_PYTHON_VERSION_MINOR) + "." + str(PySESDK.SESDK_PYTHON_VERSION_PATCH)
    assert PySESDK.SESDK_PYTHON_VERSION_STRING == py_version_str;
...
#    assert PySESDK.ExecuteScript(script,True,0,'',0,0) == 0 
...
#    assert PySESDK.ExecuteScript(script,True,0,'',0,0) == 0
    ...
    amt = 10; 
    assert PySESDK.ExecuteScript(fullscript,True,0,txhex,0,amt) == 0
