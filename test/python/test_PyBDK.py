...
def test_Versioning():
    ...
    #assert PyBDK.BDK_CORE_VERSION_MAJOR <= PyBDK.BDK_PYTHON_VERSION_MAJOR;
    #assert PyBDK.BDK_CORE_VERSION_MINOR <= PyBDK.BDK_PYTHON_VERSION_MINOR;
    #assert PyBDK.BDK_CORE_VERSION_PATCH <= PyBDK.BDK_PYTHON_VERSION_PATCH;

    #assert PyBDK.BDK_PYTHON_VERSION_MAJOR <= PyBDK.BDK_VERSION_MAJOR;
    #assert PyBDK.BDK_PYTHON_VERSION_MINOR <= PyBDK.BDK_VERSION_MINOR;
    #assert PyBDK.BDK_PYTHON_VERSION_PATCH <= PyBDK.BDK_VERSION_PATCH;

    py_version_str = str(PyBDK.BDK_PYTHON_VERSION_MAJOR) + "." + str(PyBDK.BDK_PYTHON_VERSION_MINOR) + "." + str(PyBDK.BDK_PYTHON_VERSION_PATCH)
    assert PyBDK.BDK_PYTHON_VERSION_STRING == py_version_str;
...
#    assert PyBDK.ExecuteScript(script,True,0,'',0,0) == 0 
...
#    assert PyBDK.ExecuteScript(script,True,0,'',0,0) == 0
    ...
    amt = 10; 
    assert PyBDK.ExecuteScript(fullscript,True,0,txhex,0,amt) == 0
