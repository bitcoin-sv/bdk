...
/*  DO NOT MODIFY!
   ...
   This file is a copy of $BSV/src/secp256k1/include/secp256k1.h

   It need to be cloned here so the gobdk can be a stand alone cgo package (cgo requires this include)

   This file will not be conflicted with the original file $BSV/src/secp256k1/include/secp256k1.h
   as they both use the same include guard directive SECP256K1_H
