...
func BSV_GIT_COMMIT_BRANCH() string   { return C.GoString(C.BSV_GIT_COMMIT_BRANCH) }
...
func SOURCE_GIT_COMMIT_BRANCH() string   { return C.GoString(C.SOURCE_GIT_COMMIT_BRANCH) }
