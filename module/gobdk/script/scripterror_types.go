...
// ScriptErrorCode defines error codes matching the C++ SCRIPT_ERR enum
type ScriptErrorCode int

const (
	SCRIPT_ERR_OK ScriptErrorCode = iota
	...
	// By convention, if a returned error is higher than SCRIPT_ERR_ERROR_COUNT
