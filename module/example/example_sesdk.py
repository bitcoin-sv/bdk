...
if __name__ == "__main__":
    ...
    print(script)
    #if PySESDK.ExecuteScript(script,True,0):
    if PySESDK.ExecuteScript(script,True,0,"",0,0):
    ...
    if PySESDK.ExecuteScript(script,True,0,"",0,0):
     ...
     #result = PySESDK.ExecuteScript("HASH160 0x14 0x8febbed40483661de6958d957412f82deed8e2f7 EQUAL") #0
    #result = PySESDK.ExecuteScript(
    ...
    amt = 10; 
    if PySESDK.ExecuteScript(fullscript,True,0,txhex,0,amt) ==0:
        print("Sucesss from python...execute full pay to script hash script with a transaction")
    ...
    if PySESDK.VerifyScript(scriptsig,scriptpubkey,True,0,txhex,0,amt) == 0:
