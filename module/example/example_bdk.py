...
if __name__ == "__main__":
    ...
    print(script)
    #if PyBDK.ExecuteScript(script,True,0):
    if PyBDK.ExecuteScript(script,True,0,"",0,0):
    ...
    if PyBDK.ExecuteScript(script,True,0,"",0,0):
     ...
     #result = PyBDK.ExecuteScript("HASH160 0x14 0x8febbed40483661de6958d957412f82deed8e2f7 EQUAL") #0
    #result = PyBDK.ExecuteScript(
    ...
    amt = 10; 
    if PyBDK.ExecuteScript(fullscript,True,0,txhex,0,amt) ==0:
    ...
    if PyBDK.VerifyScript(scriptsig,scriptpubkey,True,0,txhex,0,amt) == 0:
