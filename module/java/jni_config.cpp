#include <com_nchain_bdk_Config.h> // Generated
#include <jni.h>
...
JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_load(JNIEnv* env, jobject obj, jstring filename)
{
    assert(env);
    ...
    if (gArgs.IsArgSet("-maxopsperscriptpolicy"))
    {
        ...
        Java_com_nchain_bdk_Config_setMaxOpsPerScriptPolicy(env, obj, static_cast<jlong>(v));
    }
    ...
    if (gArgs.IsArgSet("-maxscriptnumlengthpolicy"))
    {
        ...
        Java_com_nchain_bdk_Config_setMaxScriptnumLengthPolicy(env, obj, static_cast<jlong>(value));
    }
    ...
    if (gArgs.IsArgSet("-maxscriptsizepolicy"))
    {
        ...
        Java_com_nchain_bdk_Config_setMaxScriptSizePolicy(env, obj, static_cast<jlong>(maxScriptSize));
    }
    ...
    if (gArgs.IsArgSet("-maxpubkeyspermultisigpolicy"))
    {
        ...
        Java_com_nchain_bdk_Config_setMaxPubkeysPerMultisigPolicy(env, obj, static_cast<jlong>(value));
    }
    ...
    if (gArgs.IsArgSet("-maxstackmemoryusageconsensus") || gArgs.IsArgSet("-maxstackmemoryusagepolicy") )
    {
        ...
        Java_com_nchain_bdk_Config_setMaxStackMemoryUsage(env, obj, static_cast<jlong>(v1), static_cast<jlong>(v2));
    }

}


JNIEXPORT jlong JNICALL Java_com_nchain_bdk_Config_getMaxOpsPerScript(JNIEnv* env, jobject obj)
{
...
// JNIEXPORT jlong JNICALL Java_com_nchain_bdk_Config_getMaxScriptNumLength(JNIEnv* env, jobject obj)
// {
//     const jboolean isGenesisEnabled = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isGenesisEnabled"));
//     const jboolean isConsensus = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isConsensus"));
...
JNIEXPORT jlong JNICALL Java_com_nchain_bdk_Config_getMaxScriptSize(JNIEnv* env, jobject obj)
{
    const jboolean isGenesisEnabled = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isGenesisEnabled"));
    const jboolean isConsensus = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isConsensus"));
...
JNIEXPORT jlong JNICALL Java_com_nchain_bdk_Config_getMaxPubKeysPerMultiSig(JNIEnv* env, jobject obj)
{
    const jboolean isGenesisEnabled = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isGenesisEnabled"));
    const jboolean isConsensus = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isConsensus"));
...
JNIEXPORT jlong JNICALL Java_com_nchain_bdk_Config_getMaxStackMemoryUsage(JNIEnv* env, jobject obj)
{
    const jboolean isGenesisEnabled = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isGenesisEnabled"));
    const jboolean isConsensus = env->GetBooleanField(obj, getBooleanFieldID(env, obj, "isConsensus"));
...
JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_setMaxOpsPerScriptPolicy(JNIEnv* env, jobject obj, jlong v)
{
    if(GlobalConfig* pConfig = getHandle<GlobalConfig>(env, obj, "cppConfig"))
    {
...
JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_setMaxScriptnumLengthPolicy(JNIEnv* env, jobject obj, jlong v)
{
    if(GlobalConfig* pConfig = getHandle<GlobalConfig>(env, obj, "cppConfig"))
    {
...
JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_setMaxScriptSizePolicy(JNIEnv* env, jobject obj, jlong v)
{
    if(GlobalConfig* pConfig = getHandle<GlobalConfig>(env, obj, "cppConfig"))
    {
...
JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_setMaxPubkeysPerMultisigPolicy(JNIEnv* env, jobject obj, jlong v)
{
    if(GlobalConfig* pConfig = getHandle<GlobalConfig>(env, obj, "cppConfig"))
    {
...
JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_setMaxStackMemoryUsage(JNIEnv* env, jobject obj, jlong v1, jlong v2)
{
    if(GlobalConfig* pConfig = getHandle<GlobalConfig>(env, obj, "cppConfig"))
    {
...
JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_initCppConfig(JNIEnv *env, jobject obj)
{
    GlobalConfig* cpp_config = new GlobalConfig();
    setHandle<GlobalConfig>(env, obj, cpp_config, "cppConfig");
}

JNIEXPORT void JNICALL Java_com_nchain_bdk_Config_deleteCppConfig(JNIEnv *env, jobject obj)
{
