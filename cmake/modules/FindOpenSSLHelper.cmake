...
# Download and install embdk following emscripten documentation https://emscripten.org/docs/getting_started/downloads.html
# set environment variables in ~/.bashrc
#export EMSDK_ROOT=/path/to/where/embdk/installed
...
source $EMSDK_ROOT/embdk_env.sh                            # Setup emscripten environment variables
...
macro(HelpFindOpenSSL)########################################################################################
  ...
  #bdkPrintOpenSSLInfo()#DebugLog
endmacro()


function(bdkPrintOpenSSLInfo)
  bdkPrintProperties(OpenSSL::Crypto)
  bdkPrintProperties(OpenSSL::SSL)
